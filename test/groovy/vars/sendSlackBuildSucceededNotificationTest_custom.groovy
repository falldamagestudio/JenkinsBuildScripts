...
class createSlackBuildSucceededNotificationTest_custom extends LocalSharedLibraryPipelineTest {
    ...
    void sendsWellFormedMessages() {
        ...
        runScript('test/jenkins/vars/sendSlackBuildSucceededNotification_custom.jenkins')
