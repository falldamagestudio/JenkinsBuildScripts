...
class createSlackBuildSucceededNotificationTest_gDrive extends LocalSharedLibraryPipelineTest {
    ...
    void sendsWellFormedMessages() {
        ...
        runScript('test/jenkins/vars/sendSlackBuildSucceededNotification_gDrive.jenkins')
