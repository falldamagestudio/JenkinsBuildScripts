...
class createSlackBuildSucceededNotificationTest_steam extends LocalSharedLibraryPipelineTest {
    ...
    void sendsWellFormedMessages() {
        ...
        runScript('test/jenkins/vars/sendSlackBuildSucceededNotification_steam.jenkins')
