...
def call(channel, projectName, committerToSlackNameLookup) {
    ...
    def messages = formatSlackNotification.getSuccessMessages(projectName, scmInfo.getCurrentChangeSetId(), scmInfo.getPeopleToInformAboutSuccessfulBuild(), committerToSlackNameLookup, scmInfo.getChangeLogs())
